...
Item {
    ...
    property alias insideCircleAndTextColor: entryPointText.color
    property alias radius: circle.radius

    //readonly property int __intialRadius: 24*5*0.5
    ...
    Rectangle {
        ...
        width: radius*2
        height: width
        color: "#000000"//"#ffffff"// "#000000" //"#bad788"
        radius: 24*5*0.5
        border.color: "#000000"
        border.width: 2*5
